...
if __name__ == "__main__":
	...
	print("Train : Intermediate train...")
	intermediate_weights, intermediate_windows, ack = trainprocess(raw_tx_train, y_train,features_tuple_list)
	print("Train : Creating new features...")
	tx_train_edited = predictprocess(raw_tx_train, intermediate_weights, intermediate_windows, ack,features_tuple_list)
	print("Test : Creating new features...")
	tx_test_edited = predictprocess(raw_tx_test, intermediate_weights, intermediate_windows, ack,features_tuple_list)
	## ========================================================= ##
	...
	y_pred_train[np.where(s > .5)] = 1
	y_pred_train = y_pred.reshape(len(tx_train_edited))
